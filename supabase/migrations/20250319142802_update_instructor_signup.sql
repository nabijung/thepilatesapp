...
DROP FUNCTION IF EXISTS create_instructor_with_studio(TEXT, TEXT, TEXT, TEXT, BIGINT, TEXT, TEXT);
DROP FUNCTION IF EXISTS create_instructor_with_studio(TEXT, TEXT, TEXT, TEXT, UUID, TEXT, TEXT);
...
BEGIN
  ...
  BEGIN
    ...
    IF p_studio_name IS NOT NULL THEN
      -- Create new studio with auto-generated UUID
      INSERT INTO studio (studio_id, name, location)
      VALUES (gen_random_uuid(), p_studio_name, COALESCE(p_studio_location, ''))
